      ...
      <div class="row mb-5">
        ...
        <div class="col-md-6 col-lg-4">
          ...
          <div class="block-21 d-flex mb-4">
            <figure class="mr-3">
              <img src="admin/images/Rooms/img_1.jpg" alt="" class="img-fluid">
            </figure>
            <div class="text">
          ...
          <div class="block-21 d-flex mb-4">
            <figure class="mr-3">
              <img src="admin/images/Rooms/img_2.jpg" alt="" class="img-fluid">
            </figure>
            <div class="text">
              <h3 class="heading"><a href="#">Our Luxury Hotel &amp; Restaurants</a></h3>
              <div class="meta">
          ...
          <div class="block-21 d-flex mb-4">
            <figure class="mr-3">
              <img src="admin/images/Rooms/img_3.jpg" alt="" class="img-fluid">
            </figure>
            <div class="text">
              <h3 class="heading"><a href="#">Our Luxury Hotel &amp; Restaurants</a></h3>
              <div class="meta">
      ...
      <div class="row pt-5">
        <div class="col-md-12 text-left">
          <p>
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  <i class="icon-heart" aria-hidden="true"></i><a href="https://colorlib.com" target="_blank" class="text-primary"></a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          </p>
        </div>
      </div>
