...
try{
		$stmt = $conn->prepare("INSERT INTO `amenities_list`(`name`,`status`,`description`,`upload_image`)VALUES(:name,:status,:description,:upload_image)");

		$executed=$stmt->execute(array(':name' => $name,':status' => $status,':description' =>$description,':upload_image' => $date1));
			   if($executed)
			   {
				  header("location:amenities_list.php");
...
<!-- Breadcrumbs-->
     ...
     <!-- <div class="form-group">
			  <div class="form-row">
			  <div class="col-md-12">
			   <label for="exampleInputName">Description</label><br>
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group col-md-12 row">
			   ...
			   <label class="col-md-2" for="description">Description:</label><br>
			   <textarea name="description" rows="5" cols="40"  class="form-control col-md-10"></textarea>
