...
{
	extract($_POST);
    $stmt = $conn->prepare("INSERT INTO `department_list`(`name`) VALUES(:name)");
            ...
            <div class="form-row">
              <div class="col-md-12">
			   <label for="exampleInputName">Name</label>
				<input class="form-control" id="exampleInputEmail1" type="text" name="name" placeholder="Enter Name of the Department"  >
